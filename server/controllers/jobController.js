...
async function postJob(req, res) {
    try {
        const { title, description, salary, location, jobType, positions, company, requirements, experience } = req.body
        ...
        const validationResponse = postJobZodSchema.safeParse({
            title, description, salary, location, jobType, positions, company, requirements, experience
        });
